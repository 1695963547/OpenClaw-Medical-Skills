...
OpenClaw Medical Skills 是一个自主医疗 AI 智能体平台，将通用大语言模型转化为专业医学与科研研究助手。平台将 **869 个生物医学技能**（涵盖临床工作流、基因组学、药物发现、生物信息学等领域）集成到统一的 LangGraph 智能体框架中。

Agent 能够通过语义搜索自主检索相关技能、生成多步骤执行计划、在沙箱环境中执行代码，并从错误中自愈——全程在交互式对话界面中运行，无需人工干预。
