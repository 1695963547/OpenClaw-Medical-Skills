...
- Monarch API v3: https://api.monarchinitiative.org/v3/api/
- API docs: https://api.monarchinitiative.org/v3/docs
...
- **Monarch portal**: https://monarchinitiative.org/
- **API v3 docs**: https://api.monarchinitiative.org/v3/docs
- **HPO browser**: https://hpo.jax.org/
